...
mock_brew() {
    case "$1" in
        ...
        "upgrade")
            ...
            echo "php 1.4.22 -> 1.4.23"
            echo "netlify-cli 17.36.3 -> 17.36.4"
            echo "==> Downloading https://ghcr.io/v2/homebrew/core/php/manifests/1.4.23"
            echo "################################################################################################################# 100.0%"
            echo "==> Fetching php"
            echo "==> Downloading https://ghcr.io/v2/homebrew/core/php/blobs/sha256:038c79a890f8bfa86b4ad80b023a5d2d159e5560ee9fff8cb4"
            echo "################################################################################################################# 100.0%"
            ...
            echo "==> Upgrading php"
            echo "  1.4.22 -> 1.4.23"
            echo "==> Pouring php--1.4.23.arm64_sequoia.bottle.tar.gz"
            echo "🍺  /opt/homebrew/Cellar/php/1.4.23: 1,424 files, 16MB"
            echo "==> Running \`brew cleanup php\`..."
            ...
            echo "Removing: /opt/homebrew/Cellar/php/1.4.22... (1,424 files, 16MB)"
